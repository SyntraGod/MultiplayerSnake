...
public class MultiplayerGame implements Runnable{
    ...
    public MultiplayerGame(Player player) throws IOException {
        ...
        String initMap = RunClientTest.client.getInputStream();
        ...
        private void updatePanel() throws IOException {
            ...
            RunClientTest.client.flushOutputStream(nameKey);


            //Update enemy movement
            String[] enemyMovement = RunClientTest.client.getInputStream().split(":");
    ...
    public void run() {
        ...
        if(player.getSnake().isMultiplayerOver(enemySnake) || enemySnake.isMultiplayerOver(snake)) {
            try {
                RunClientTest.client.flushOutputStream("end");
            } catch (IOException e) {
                throw new RuntimeException(e);
            }
