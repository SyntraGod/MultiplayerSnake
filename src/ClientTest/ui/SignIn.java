...
import static ClientTest.RunClientTest.signInOption;
...
public class SignIn {
    ...
    public SignIn(){
        ...
        jButton.addActionListener(new SignIn.Action());
    }
                ...
                try {
                    ...
                    if (player.getPassword().equals(password)) {
                        if(player.getStatus() == 0) //Not online
                        {
                            ...
                            RunClientTest.client.setPlayer(player);
                            ...
                            RunClientTest.client.flushOutputStream(signInpackage);
                            //response from server
                            String response = RunClientTest.client.getInputStream();
                            RunClientTest.client.setIdClient(Integer.parseInt(response));
                            frame.dispose();
